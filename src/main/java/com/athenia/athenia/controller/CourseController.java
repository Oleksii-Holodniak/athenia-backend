...
public class CourseController {
	...
	private List<LectureDTO> getLecturesDTO(Course course) {
		List<Lecture> lectures = lectureService.findLectures(course);
		List<LectureDTO> lecturesDTO = new ArrayList<>(lectures.size());
